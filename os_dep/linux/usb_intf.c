...
static int __init rtw_drv_entry(void)
{
	...
	DBG_871X_LEVEL(_drv_debug_, "module init start\n");
...
exit:
	DBG_871X_LEVEL(_drv_debug_, "module init ret=%d\n", ret);
	return ret;
}

static void __exit rtw_drv_halt(void)
{
	DBG_871X_LEVEL(_drv_debug_, "module exit start\n");
	...
	DBG_871X_LEVEL(_drv_debug_, "module exit success\n");
